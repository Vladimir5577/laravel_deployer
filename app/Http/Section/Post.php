...
class Post extends Section implements Initializable
{
    ...
    public function onDisplay($payload = [])
    {
        $columns = [
            ...
            AdminColumn::image('image', 'get'),
            AdminColumn::link('user_name', 'user_name', 'created_at')
            ...
            ,
             AdminColumn::link('description', 'description', 'created_at')
                ->setSearchCallback(function($column, $query, $search){
                    return $query
            ...
            ,
            \AdminColumnEditable::checkbox('is_active', 'Active', 'Not', 'Display'),
